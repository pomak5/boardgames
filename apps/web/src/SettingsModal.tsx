  ...
  return (
    <div className="st-overlay" onClick={onClose}>
      ...
      >
        ...
        <div className="st-section">
          <label className="st-field" htmlFor="st-theme">
            ...
            >
              ...
              <option value="dark">🛋️ Тёмный лаунж</option>
            </select>
          </label>
          ...
          <label className="st-toggle">
            ...
            <span>
              ...
              <span className="st-hint">Отключает «ручной» наклон карт в Коднеймс</span>
            </span>
          </label>
        </div>
        ...
        <p className="st-foot">Настройки сохраняются автоматически на этом устройстве.</p>
      </div>
    </div>
  );
}
